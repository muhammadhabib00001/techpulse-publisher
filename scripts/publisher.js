...
4. STRUCTURE: Provide 6 sections:
   ...
   - Section 6: Titled "Frequently Asked Questions" (id: "frequently-asked-questions"). In contentHtml, provide a brief 1-2 sentence lead paragraph, and at the bottom a "Final Thoughts" block. Do NOT write FAQ questions and answers inside contentHtml because they are automatically rendered as beautiful cards from the "faqs" JSON field!
...
function renderArticleHtml(articleData, author, category, heroImage) {
  ...
  const sectionsHtml = articleData.sections.map((sec, idx) => {
    ...
    // If this is the FAQ section and articleData.faqs exists, strip duplicate plain-text Q&A from contentHtml and append the styled FAQ Q&A cards
    let faqBlock = '';
